    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        exit.setOnClickListener(new View.OnClickListener() {  // 정말로 나가기
            ...
            public void onClick(View v) {
                ...
                ((view_modifyActivity) viewModifyContext).manager.beginTransaction()
                                                         .show(((view_modifyActivity) viewModifyContext).frg_view)
                                                         .hide(mFragment).remove(((view_modifyActivity) viewModifyContext).frg_modify)
                                                         .remove(((view_modifyActivity) viewModifyContext).frg_backbox2)
                                                         .remove(((view_modifyActivity) viewModifyContext).frg_savebox2)
                                                         .commit();
                ...
                ((view_modifyActivity) viewModifyContext).manager.beginTransaction()
                                                         .add(R.id.frameLayout, ((view_modifyActivity) viewModifyContext).frg_modify)
                                                         .hide(((view_modifyActivity) viewModifyContext).frg_modify)
                                                         .add(R.id.frameLayout, ((view_modifyActivity) viewModifyContext).frg_backbox2)
                                                         .hide(((view_modifyActivity) viewModifyContext).frg_backbox2)
                                                         .add(R.id.frameLayout, ((view_modifyActivity) viewModifyContext).frg_savebox2)
                                                         .hide(((view_modifyActivity) viewModifyContext).frg_savebox2)
                                                         .commit();
            }
        });
