...
public class SaveBoxFragment2 extends Fragment {
    private SaveBoxFragment2 mFragment;
    private Boolean saveAlreadyClicked = false; // 저장버튼 두 번 눌러서 저장 2번 되는 걸 방지
        ...
        confirm.setOnClickListener(new View.OnClickListener() {  // 내용 저장
            ...
            public void onClick(View v) {
                if (saveAlreadyClicked == false) { // 저장버튼 두 번 눌러서 저장 2번 되는 걸 방지
                    ...
                    String title = ((view_modifyActivity)viewModifyContext).title;
                    String content = ((view_modifyActivity)viewModifyContext).content;
                    ...
                    DataProcess.saveNote(getContext(), title, content, ((view_modifyActivity)viewModifyContext).pics, ((view_modifyActivity)viewModifyContext).urls);
